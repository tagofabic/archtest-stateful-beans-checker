package io.github.statefulbeans.core.util;

import java.util.Set;

/**
 * Centralised string constants for annotation class names used across the library.
 * Using strings avoids hard compile-time dependencies on Spring / Lombok.
 */
public final class AnnotationNames {
    ...
    public static final Set<String> SPRING_BEAN_ANNOTATIONS = Set.of(
            COMPONENT, SERVICE, REPOSITORY, CONTROLLER,
            REST_CONTROLLER, CONFIGURATION, MANAGED_BEAN, NAMED
    );
    ...
    public static final Set<String> LOMBOK_MUTABLE_CLASS_ANNOTATIONS = Set.of(
            LOMBOK_DATA, LOMBOK_SETTER
    );
}
